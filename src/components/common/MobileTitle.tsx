...
export default function MobileTitle({
  ...
  return (
    <>
      <Card className="fixed top-0 right-0 left-0 z-102 h-18 w-full rounded-none bg-[var(--color-background)] px-6 font-bold sm:text-lg md:hidden dark:bg-[var(--color-black)]">
